...
static UIImage* _imageOfPlaneIcon = nil;
...
{
    [ANCloudKit drawSmallCloudIconWithFrame: CGRectMake(0, 0, 82, 37) resizing: ANCloudKitResizingBehaviorStretch];
}

+ (void)drawSmallCloudIconWithFrame: (CGRect)targetFrame resizing: (ANCloudKitResizingBehavior)resizing
{
    ...
    CGRect resizedFrame = ANCloudKitResizingBehaviorApply(resizing, CGRectMake(0, 0, 82, 37), targetFrame);
...
{
    [ANCloudKit drawMiddleCloudIconWithFrame: CGRectMake(0, 0, 107, 58) resizing: ANCloudKitResizingBehaviorStretch];
}

+ (void)drawMiddleCloudIconWithFrame: (CGRect)targetFrame resizing: (ANCloudKitResizingBehavior)resizing
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Resize to Target Frame
    CGContextSaveGState(context);
    CGRect resizedFrame = ANCloudKitResizingBehaviorApply(resizing, CGRectMake(0, 0, 107, 58), targetFrame);
    CGContextTranslateCTM(context, resizedFrame.origin.x, resizedFrame.origin.y);
...
{
    [ANCloudKit drawLargeCloudIconWithFrame: CGRectMake(0, 0, 129, 57) resizing: ANCloudKitResizingBehaviorStretch];
}

+ (void)drawLargeCloudIconWithFrame: (CGRect)targetFrame resizing: (ANCloudKitResizingBehavior)resizing
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Resize to Target Frame
    CGContextSaveGState(context);
    CGRect resizedFrame = ANCloudKitResizingBehaviorApply(resizing, CGRectMake(0, 0, 129, 57), targetFrame);
    CGContextTranslateCTM(context, resizedFrame.origin.x, resizedFrame.origin.y);
...
+ (void)drawSunIcon
{
    [ANCloudKit drawSunIconWithFrame: CGRectMake(0, 0, 79, 79) resizing: ANCloudKitResizingBehaviorStretch];
}
...
+ (void)drawSunIconWithFrame: (CGRect)targetFrame resizing: (ANCloudKitResizingBehavior)resizing
{
    ...
    //// Resize to Target Frame
    CGContextSaveGState(context);
    CGRect resizedFrame = ANCloudKitResizingBehaviorApply(resizing, CGRectMake(0, 0, 79, 79), targetFrame);
    CGContextTranslateCTM(context, resizedFrame.origin.x, resizedFrame.origin.y);
...
+ (void)drawPlaneIcon
{
    [ANCloudKit drawPlaneIconWithFrame: CGRectMake(0, 0, 70, 33) resizing: ANCloudKitResizingBehaviorStretch];
}

+ (void)drawPlaneIconWithFrame: (CGRect)targetFrame resizing: (ANCloudKitResizingBehavior)resizing
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Resize to Target Frame
    CGContextSaveGState(context);
    CGRect resizedFrame = ANCloudKitResizingBehaviorApply(resizing, CGRectMake(0, 0, 70, 33), targetFrame);
    CGContextTranslateCTM(context, resizedFrame.origin.x, resizedFrame.origin.y);
    CGContextScaleCTM(context, resizedFrame.size.width / 70, resizedFrame.size.height / 33);
    ...
    //// Group
    {
        ...
        [clipPath moveToPoint: CGPointMake(19.64, 12.17)];
        [clipPath addLineToPoint: CGPointMake(61.88, 4.68)];
        [clipPath addCurveToPoint: CGPointMake(69.01, 9.67) controlPoint1: CGPointMake(65.23, 4.09) controlPoint2: CGPointMake(68.42, 6.33)];
        [clipPath addCurveToPoint: CGPointMake(64.02, 16.8) controlPoint1: CGPointMake(69.6, 13.02) controlPoint2: CGPointMake(67.36, 16.21)];
        [clipPath addLineToPoint: CGPointMake(32.13, 22.42)];
        [clipPath addCurveToPoint: CGPointMake(22.69, 22.16) controlPoint1: CGPointMake(32.13, 22.42) controlPoint2: CGPointMake(27.19, 23.25)];
        [clipPath addCurveToPoint: CGPointMake(14.56, 18.17) controlPoint1: CGPointMake(18.18, 21.07) controlPoint2: CGPointMake(14.56, 18.17)];
        [clipPath addLineToPoint: CGPointMake(2.22, 8.18)];
        [clipPath addCurveToPoint: CGPointMake(2.03, 6.48) controlPoint1: CGPointMake(2.22, 8.18) controlPoint2: CGPointMake(0.15, 6.86)];
        [clipPath addCurveToPoint: CGPointMake(7.83, 6.13) controlPoint1: CGPointMake(3.91, 6.1) controlPoint2: CGPointMake(5.98, 5.78)];
        [clipPath addCurveToPoint: CGPointMake(19.53, 12.12) controlPoint1: CGPointMake(10.62, 6.66) controlPoint2: CGPointMake(19.53, 12.12)];
        [clipPath addLineToPoint: CGPointMake(19.64, 12.17)];
        [clipPath closePath];
        ...
        //// Rectangle Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 35.6, 11.15);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(-38.15, -15.48, 76.3, 30.95)];
        [fillColor2 setFill];
        [rectanglePath fill];
    ...
    //// Bezier 2 Drawing
    UIBezierPath* bezier2Path = [UIBezierPath bezierPath];
    [bezier2Path moveToPoint: CGPointMake(19.64, 12.17)];
    [bezier2Path addLineToPoint: CGPointMake(61.88, 4.68)];
    [bezier2Path addCurveToPoint: CGPointMake(69.01, 9.67) controlPoint1: CGPointMake(65.23, 4.09) controlPoint2: CGPointMake(68.42, 6.33)];
    [bezier2Path addCurveToPoint: CGPointMake(64.02, 16.8) controlPoint1: CGPointMake(69.6, 13.02) controlPoint2: CGPointMake(67.36, 16.21)];
    [bezier2Path addLineToPoint: CGPointMake(32.13, 22.42)];
    [bezier2Path addCurveToPoint: CGPointMake(22.69, 22.16) controlPoint1: CGPointMake(32.13, 22.42) controlPoint2: CGPointMake(27.19, 23.25)];
    [bezier2Path addCurveToPoint: CGPointMake(14.56, 18.17) controlPoint1: CGPointMake(18.18, 21.07) controlPoint2: CGPointMake(14.56, 18.17)];
    [bezier2Path addLineToPoint: CGPointMake(2.22, 8.18)];
    [bezier2Path addCurveToPoint: CGPointMake(2.03, 6.48) controlPoint1: CGPointMake(2.22, 8.18) controlPoint2: CGPointMake(0.15, 6.86)];
    [bezier2Path addCurveToPoint: CGPointMake(7.83, 6.13) controlPoint1: CGPointMake(3.91, 6.1) controlPoint2: CGPointMake(5.98, 5.78)];
    [bezier2Path addCurveToPoint: CGPointMake(19.53, 12.12) controlPoint1: CGPointMake(10.62, 6.66) controlPoint2: CGPointMake(19.53, 12.12)];
    [bezier2Path addLineToPoint: CGPointMake(19.64, 12.17)];
    [bezier2Path closePath];
    [strokeColor setStroke];
    bezier2Path.lineWidth = 1;
    ...
    //// Group 2
    {
        ...
        [clip2Path moveToPoint: CGPointMake(48.51, 7.06)];
        [clip2Path addLineToPoint: CGPointMake(30.24, 1.49)];
        [clip2Path addLineToPoint: CGPointMake(23.89, 2.63)];
        [clip2Path addCurveToPoint: CGPointMake(23.76, 3.3) controlPoint1: CGPointMake(23.34, 2.73) controlPoint2: CGPointMake(23.29, 3.03)];
        [clip2Path addLineToPoint: CGPointMake(34.62, 9.53)];
        [clip2Path addLineToPoint: CGPointMake(48.51, 7.06)];
        [clip2Path closePath];
        ...
        //// Rectangle 2 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 35.95, 4.9);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRect: CGRectMake(-17, -9.35, 34, 18.7)];
        [fillColor2 setFill];
        [rectangle2Path fill];
    ...
    //// Bezier 4 Drawing
    UIBezierPath* bezier4Path = [UIBezierPath bezierPath];
    [bezier4Path moveToPoint: CGPointMake(48.51, 7.06)];
    [bezier4Path addLineToPoint: CGPointMake(30.24, 1.49)];
    [bezier4Path addLineToPoint: CGPointMake(23.89, 2.63)];
    [bezier4Path addCurveToPoint: CGPointMake(23.76, 3.3) controlPoint1: CGPointMake(23.34, 2.73) controlPoint2: CGPointMake(23.29, 3.03)];
    [bezier4Path addLineToPoint: CGPointMake(34.62, 9.53)];
    [bezier4Path addLineToPoint: CGPointMake(48.51, 7.06)];
    [bezier4Path closePath];
    [strokeColor setStroke];
    bezier4Path.lineWidth = 1;
    ...
    //// Group 3
    {
        ...
        //// Clip Clip 3
        UIBezierPath* clip3Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(28.4, 14.1, 2.2, 2.2)];
        [clip3Path addClip];


        //// Rectangle 3 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 29.5, 15.2);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle3Path = [UIBezierPath bezierPathWithRect: CGRectMake(-6.08, -6.08, 12.15, 12.15)];
        [fillColor3 setFill];
        [rectangle3Path fill];
    ...
    //// Group 4
    {
        ...
        //// Clip Clip 4
        UIBezierPath* clip4Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(34.1, 13.1, 2.2, 2.2)];
        [clip4Path addClip];


        //// Rectangle 4 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 35.2, 14.2);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRect: CGRectMake(-6.08, -6.08, 12.15, 12.15)];
        [fillColor3 setFill];
        [rectangle4Path fill];
    ...
    //// Group 5
    {
        ...
        //// Clip Clip 5
        UIBezierPath* clip5Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(39.8, 12.1, 2.2, 2.2)];
        [clip5Path addClip];


        //// Rectangle 5 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 40.9, 13.2);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle5Path = [UIBezierPath bezierPathWithRect: CGRectMake(-6.08, -6.08, 12.15, 12.15)];
        [fillColor3 setFill];
        [rectangle5Path fill];
    ...
    //// Group 6
    {
        ...
        //// Clip Clip 6
        UIBezierPath* clip6Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(45.5, 11.1, 2.2, 2.2)];
        [clip6Path addClip];


        //// Rectangle 6 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 46.6, 12.2);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle6Path = [UIBezierPath bezierPathWithRect: CGRectMake(-6.08, -6.08, 12.15, 12.15)];
        [fillColor3 setFill];
        [rectangle6Path fill];
    ...
    //// Group 7
    {
        ...
        //// Clip Clip 7
        UIBezierPath* clip7Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(51.2, 10.1, 2.2, 2.2)];
        [clip7Path addClip];


        //// Rectangle 7 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 52.3, 11.2);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle7Path = [UIBezierPath bezierPathWithRect: CGRectMake(-6.08, -6.08, 12.15, 12.15)];
        [fillColor3 setFill];
        [rectangle7Path fill];
    ...
    //// Bezier 5 Drawing
    UIBezierPath* bezier5Path = [UIBezierPath bezierPath];
    [bezier5Path moveToPoint: CGPointMake(53.27, 6.25)];
    [bezier5Path addLineToPoint: CGPointMake(56.42, 8.85)];
    [bezier5Path addCurveToPoint: CGPointMake(60.84, 10.01) controlPoint1: CGPointMake(57.49, 9.73) controlPoint2: CGPointMake(59.47, 10.25)];
    [bezier5Path addLineToPoint: CGPointMake(68.19, 8.72)];
    [strokeColor setStroke];
    bezier5Path.lineWidth = 1;
    ...
    //// Group 8
    {
        ...
        //// Clip Clip 8
        UIBezierPath* clip8Path = [UIBezierPath bezierPath];
        [clip8Path moveToPoint: CGPointMake(53.1, 15.1)];
        [clip8Path addLineToPoint: CGPointMake(36.45, 18.03)];
        [clip8Path addLineToPoint: CGPointMake(22.61, 32.4)];
        [clip8Path addLineToPoint: CGPointMake(30.32, 31.04)];
        [clip8Path addLineToPoint: CGPointMake(53.1, 15.1)];
        [clip8Path closePath];
        clip8Path.usesEvenOddFillRule = YES;
        [clip8Path addClip];


        //// Rectangle 8 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 37.85, 23.75);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle8Path = [UIBezierPath bezierPathWithRect: CGRectMake(-21.53, -10.88, 43.05, 21.75)];
        [fillColor2 setFill];
        [rectangle8Path fill];
    ...
    //// Bezier 7 Drawing
    UIBezierPath* bezier7Path = [UIBezierPath bezierPath];
    [bezier7Path moveToPoint: CGPointMake(53.1, 15.1)];
    [bezier7Path addLineToPoint: CGPointMake(36.45, 18.03)];
    [bezier7Path addLineToPoint: CGPointMake(22.61, 32.4)];
    [bezier7Path addLineToPoint: CGPointMake(30.32, 31.04)];
    [bezier7Path addLineToPoint: CGPointMake(53.1, 15.1)];
    [bezier7Path closePath];
    [strokeColor setStroke];
    bezier7Path.lineWidth = 1;
    ...
    //// Group 9
    {
        ...
        //// Clip Clip 9
        UIBezierPath* clip9Path = [UIBezierPath bezierPath];
        [clip9Path moveToPoint: CGPointMake(19.55, 12.2)];
        [clip9Path addLineToPoint: CGPointMake(9.49, 13.93)];
        clip9Path.usesEvenOddFillRule = YES;
        [clip9Path addClip];


        //// Rectangle 9 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 14.5, 13.05);
        CGContextRotateCTM(context, -10 * M_PI/180);

        UIBezierPath* rectangle9Path = [UIBezierPath bezierPathWithRect: CGRectMake(-10.1, -5.03, 20.2, 10.05)];
        [fillColor2 setFill];
        [rectangle9Path fill];
    ...
    //// Bezier 9 Drawing
    UIBezierPath* bezier9Path = [UIBezierPath bezierPath];
    [bezier9Path moveToPoint: CGPointMake(19.55, 12.2)];
    [bezier9Path addLineToPoint: CGPointMake(9.49, 13.93)];
    [strokeColor setStroke];
    bezier9Path.lineWidth = 1;
...
+ (UIImage*)imageOfMiddleCloudIcon
{
    ...
    [ANCloudKit drawMiddleCloudIcon];
...
{
    if (_imageOfPlaneIcon)
        return _imageOfPlaneIcon;

    UIGraphicsBeginImageContextWithOptions(CGSizeMake(70, 33), NO, 0);
    [ANCloudKit drawPlaneIcon];

    _imageOfPlaneIcon = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
...
- (void)setSmallCloudIconTargets: (NSArray*)smallCloudIconTargets
{
    ...
    for (id target in smallCloudIconTargets)
        [target performSelector: @selector(setImage:) withObject: ANCloudKit.imageOfSmallCloudIcon];
}
...
- (void)setMiddleCloudIconTargets: (NSArray*)middleCloudIconTargets
{
    ...
    for (id target in middleCloudIconTargets)
        [target performSelector: @selector(setImage:) withObject: ANCloudKit.imageOfMiddleCloudIcon];
}
...
- (void)setLargeCloudIconTargets: (NSArray*)largeCloudIconTargets
{
    ...
    for (id target in largeCloudIconTargets)
        [target performSelector: @selector(setImage:) withObject: ANCloudKit.imageOfLargeCloudIcon];
}
...
- (void)setSunIconTargets: (NSArray*)sunIconTargets
{
    ...
    for (id target in sunIconTargets)
        [target performSelector: @selector(setImage:) withObject: ANCloudKit.imageOfSunIcon];
}

- (void)setPlaneIconTargets: (NSArray*)planeIconTargets
{
    _planeIconTargets = planeIconTargets;

    for (id target in planeIconTargets)
        [target performSelector: @selector(setImage:) withObject: ANCloudKit.imageOfPlaneIcon];
}
...
CGRect ANCloudKitResizingBehaviorApply(ANCloudKitResizingBehavior behavior, CGRect rect, CGRect target)
{
    ...
    switch (behavior)
    {
        case ANCloudKitResizingBehaviorAspectFit:
        {
            scales.width = MIN(scales.width, scales.height);
            scales.height = scales.width;
            break;
        }
        case ANCloudKitResizingBehaviorAspectFill:
        {
            scales.width = MAX(scales.width, scales.height);
            scales.height = scales.width;
            break;
        }
        case ANCloudKitResizingBehaviorStretch:
            break;
        case ANCloudKitResizingBehaviorCenter:
        {
            scales.width = 1;
            scales.height = 1;
            break;
